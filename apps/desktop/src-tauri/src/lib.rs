...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::runtime_extra::get_run_outputs,
            commands::runtime_extra::load_json_value_bytes,
            ...
            commands::secret::get_secret_store_status,
            commands::secret::initialize_secret_store,
            commands::secret::unlock_secret_store,
            commands::secret::list_secrets,
            commands::secret::put_secret,
            ...
            commands::graph::apply_graph,
            commands::graph::get_graph_revision_for_graph,
            commands::context::commit_context_patch,
            commands::context::get_working_context,
            commands::context::get_context_at_commit,
            commands::context::list_context_commits,
            commands::context::diff_context_commits,
            commands::context::create_version_snapshot,
            commands::artifact::create_artifact_staging,
            commands::artifact::complete_artifact_staging,
            commands::artifact::get_artifact_staging,
            commands::artifact::commit_artifact_staging,
            commands::artifact::get_artifact,
            commands::artifact::list_artifacts,
            commands::artifact::download_artifact,
            commands::secret::lock_secret_store,
            commands::secret::change_master_password,
            commands::tool::list_tool_descriptors,
        ])
