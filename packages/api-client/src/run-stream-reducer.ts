...
const KNOWN_DURABLE_EVENTS = new Set([
  ...
  "node.completed", "node.failed", "node.waiting", "node.wait.resolved", "node.wait.expired",
  "node.attempt.leased", "node.attempt.timed_out",
  ...
  "llm.tool.memory_proposals_requested", "llm.tool.memory_proposals_resolved",
  "llm.call.started", "llm.call.completed", "llm.call.failed", "llm.call.outcome_unknown",
  "llm.call.retry_ready", "tool.call.requested", "tool.call.awaiting_approval",
  "tool.call.started", "tool.call.completed", "tool.call.failed", "tool.call.outcome_unknown",
  "tool.call.retry_ready", "tool.call.retry_prepared", "effect.prepared", "effect.started",
  "effect.succeeded", "effect.failed", "effect.outcome_unknown", "effect.outcome_unknown.recorded",
  "effect.attempt.outcome_unknown", "effect.retry_ready", "effect.abandoned_unknown", "effect.resolved",
  "state.patch.committed", "checkpoint.created", "artifact.committed",
  "memory.proposal.created", "memory.proposal.status_changed",
  "conversation.turn_submitted", "conversation.candidate_regenerated", "conversation.candidate_ready",
  "conversation.selection_changed", "conversation.candidate_projection_resolved",
]);
